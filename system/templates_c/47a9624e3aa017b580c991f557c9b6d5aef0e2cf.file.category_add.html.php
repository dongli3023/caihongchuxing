<?php /* Smarty version Smarty-3.0.8, created on 2015-06-23 21:44:39
         compiled from "D:\wamp\www\guoxun\system/templates/admin/category_add.html" */ ?>
<?php /*%%SmartyHeaderCode:935558962c7a54296-27497477%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47a9624e3aa017b580c991f557c9b6d5aef0e2cf' => 
    array (
      0 => 'D:\\wamp\\www\\guoxun\\system/templates/admin/category_add.html',
      1 => 1435066899,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '935558962c7a54296-27497477',
  'function' => 
  array (
  ),
...
<?php }?></option>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" name="encatname" class="txt" size="30" id="catname"></td>
  </tr>
  <tr>
...
" <?php if ($_smarty_tpl->getVariable('url_arr')->value[2]==$_smarty_tpl->tpl_vars['value']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['value']->value['urldemo'];?>
  ...
  <tr>
    ...
    <td colspan="3"><textarea name="description" cols="45" rows="5"></textarea></td>
  </tr> 
  <tr>
